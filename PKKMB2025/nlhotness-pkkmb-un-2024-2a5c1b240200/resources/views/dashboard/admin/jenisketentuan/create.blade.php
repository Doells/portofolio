    ...
    <main class="h-full overflow-y-auto">
            ...
            <div class="grid w-full gap-5 px-0 lg:px-10 mx-auto md:grid-cols-12">
                <div class="col-span-12">
                    <h2 class="lg:mt-8 mb-1 text-2xl font-semibold text-gray-700">
                        Tambah Jenis Ketentuan PKKMB 2023
                    </h2>
                    <p class="text-xs lg:text-sm text-gray-400">
                        Unggah jenis ketentuan kegiatan PKKMB 2023
                    </p>
                </div>
            </div>
        </div>
        ...
        <nav class="hidden lg:block lg:mx-10 mt-5 lg:mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <p class="text-xs lg:text-sm font-medium">Tambah Jenis Ketentuan Kegiatan</p>
                </li>
            </ol>
        </nav>
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-0">
                    <div class="lg:px-2 lg:py-2 lg:mt-2 bg-white rounded-xl">
                        ...
                        <form action="{{ route('admin.jenisketentuan.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="lg:px-4 lg:py-5">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Judul Jenis Ketentuan" type="text"  style="text-transform: capitalize;" name="title" id="title" autocomplete="title" class="block w-full py-2 lg:py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 text-sm lg:text-base" value="{{ old('title') }}" required>
