        ...
        <nav class="hidden lg:block lg:mx-10 mt-5 lg:mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                <li class="flex items-center">
                    <a href="{{ route('admin.news.index') }}" class="text-xs lg:text-sm text-gray-400">Berita PKKMB 2023</a>
                ...
                <li class="flex items-center">
                    <p class="text-xs lg:text-sm font-medium">Edit Berita PKKMB 2023</p>
                </li>
            </ol>
        </nav>
