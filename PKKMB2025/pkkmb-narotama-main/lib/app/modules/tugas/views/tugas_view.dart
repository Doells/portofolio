...
import 'package:pkkmb/app/modules/tugas/views/tugas_detail_view.dart';
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () => Get.to(TugasDetailView(tugas: tugas)),
              child: NaroCard(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 12),
                          tugas.hasil != null && tugas.hasil!.isNotEmpty ? Container(
